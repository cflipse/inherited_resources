    ...
    def self.inherit_resources(base)
      base.class_eval do
        ...
        base.with_options :instance_writer => false do |c|
          ...
          c.class_inheritable_hash :resources_configuration, :scopes_configuration, :userstamp_configuration
        end

        protected :resource_class, :parents_symbols, :resources_configuration, :scopes_configuration, :userstamp_configuration
      end
    end
